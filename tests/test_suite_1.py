...
# Open map leveled on 13 (RR: the expected terrain tiles)
    def test1_2(self):
        ...
        takeScreenAndCompare(callback, driver, driver1, "test1_2")
...
# Click on the region (OR: light district, balun with the name of locality)
    def test1_3(self):
        ...
        takeScreenAndCompare(callback, driver, driver1, "test1_3")
...
# Prizumitsya 17 shifted to the Left (RR: lights in place, zoom level 17)
    def test1_4(self):
        ...
        takeScreenAndCompare(callback, driver, driver1, "test1_4")
...
# Click on the street (OR: street lights, balun)
    def test1_5(self):
        ...
        takeScreenAndCompare(callback, driver, driver1, "test1_5")
...
# Click on the building (RR: Balun with information about the building in which was a click)
    def test1_6(self):
        ...
        takeScreenAndCompare(callback, driver, driver1, "test1_6")
...
# Show a list of organizations in the building (RR: a list of organizations in the building)
    def test1_7(self):
        ...
        takeScreenAndCompare(callback, driver, driver1, "test1_7")
...
# Proskrolit list of organizations (RR: proskrolen list)
    def test1_8(self):
        ...
        takeScreenAndCompare(callback, driver, driver1, "test1_8")
...
# Klinut on the next building (RR: previous balun imploded, opened a new one)
    def test1_9(self):
        ...
        takeScreenAndCompare(callback, driver, driver1, "test1_9")
# Expand the list of organizations
    def test1_z10(self):
        ...
        takeScreenAndCompare(callback, driver, driver1, "test1_10")
# Close balun clicking on the X (RR: balun imploded on the map tiles only)
    def test1_z11(self):
        ...
        takeScreenAndCompare(callback, driver, driver1, "test1_11")